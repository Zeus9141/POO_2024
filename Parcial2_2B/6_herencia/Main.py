...
"""
#METODO CONSTRUCTOR.- Este método especial dentro de una clase se utiliza para dar un valor a los atributos del objeto al crearlo. Es el primer método que se ejecuta al crear el objeto y se manda llamar automáticamente al crearlo, es decir, este método puede recibir parámetros al momento de crear el objeto.

#Cuando se crea un método constructor se utiliza la función init(), para que se llame automáticamente cada vez que se utiliza la clase para crear un nuevo objeto.
...
#No es necesario que tenga nombre self, puedes llamarlo como quieras, pero tiene que ser el primer parámetro de cualquier función de la clase. Es decir por regla se utiliza en la palabra self, pero puede ser llamado con otro nombre por ejemplo: valor, abd, parámetro, etc.
...
class Coches:
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
    # El encapsulamiento o visibildad es importante que aa través de el es
    # posible que python sepa cómo se va a autilizar y manipular los atributos y
    # métodos de la clase
    ...
    #Nota 1: Para utilizar un atributo privado es necesario usarlo dentro de un método público
    ...
    #Nota 2: Para utilizar un método privado es necesario usarlo dentro de un método público
...
class camiones(Coches):
    def __init__(self, color, marca, modelo, velocidad, eje, caballaje, plazas,capacidadCarga):
      super().__init__( color, marca, modelo, velocidad, eje, caballaje, plazas,capacidadCarga)
      self.__eje=eje
    ...
    def sercapacidadCarga(self,capacidadCarga):
       self.__capacidadCarga:capacidadCarga
